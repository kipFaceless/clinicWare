...
@section('body')
    <div class="login-box">
        ...
        <!-- /.login-logo -->
        <div class="login-box-body" style="background: rgba(0,0,0,.6); border-radius: 3px; box-shadow: 2px 4px 4px rgba(0,0,0,.4)">
            <p class="login-box-msg white-text">{{ trans('adminlte::adminlte.login_message') }}</p>
            <form action="{{ url(config('adminlte.login_url', 'login')) }}" method="post">
                ...
                <div class="row">
                    ...
                    <!-- /.col -->
                    <div class="col-xs-4">
                        <button type="submit" style="font-size: 12px!important;"
